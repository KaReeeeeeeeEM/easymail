...
export default async function SenderPage() {
  ...
  return <div className="flex flex-col gap-8">
    <PageHeading eyebrow="Dynamic delivery providers" title="SMTP senders" description="Connect and manage as many standards-compliant SMTP accounts as your workspace needs." action={<SmtpConfigurationForm />} />

  ...
  async function create(formData: FormData) {
    ...
    try {
      ...
      if (result.error || !result.data)
        return toast.error(
          result.error?.message ?? "You can create a maximum of 5 workspaces.",
        );
    ...
    >
      <Empty className="min-h-[420px] border bg-card/40">
        <EmptyHeader>
          ...
          <EmptyDescription>
            Create a personal or organization workspace to configure senders,
            issue API keys, and view your delivery overview.
          </EmptyDescription>
        </EmptyHeader>
        <EmptyContent>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Use your name for a personal service or your organization name for a
            shared service. Each account can create up to 5 workspaces.
          </DialogDescription>
        </DialogHeader>
        <form
          onSubmit={(event) => {

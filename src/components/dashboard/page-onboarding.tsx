...
const guides: Record<string, Guide> = {
  ...
  sender: { title: "Connect delivery providers", description: "Saved credentials are encrypted and verified before use.", steps: [{ title: "Choose the exact provider", description: "Gmail, Yahoo, Zoho, and Amazon SES each show their own host defaults and credential instructions before verification.", target: "nav-smtp-senders" }, { title: "Read the provider guides", description: "Documentation explains app passwords, SES SMTP credentials, OAuth limitations, and secure custom SMTP setup.", target: "nav-documentation" }] },
